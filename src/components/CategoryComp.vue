<template>
      ...
      <div class="container mt-5 border shadow table-responsive">
        <div class="add my-3">
          <button class="btn btn-success" @click="addCustomer">
            <i class="fa-solid fa-plus fw-bold"></i> Add Category
          </button>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" v-model="newCustomer.category" required>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-warning text-white">
                <h5 class="modal-title" id="editCustomerModalLabel">Edit Category</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form @submit.prevent="submitEditForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" v-model="editCustomer.category" required>
                    </div>
  ...
  const submitCustomerForm = async () => {
      const response = await axios.post('http://localhost:8000/api/categories', newCustomer.value);
  ...
  const deleteCustomer = async (customerId) => {
      await axios.delete(`http://localhost:8000/api/categories/${customerId}`);
  ...
  const submitEditForm = async () => {
      const response = await axios.patch(`http://localhost:8000/api/categories/${editCustomer.value.id}`, editCustomer.value);
